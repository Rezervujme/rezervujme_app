...
class _$CategoryTearOff {
  ...
  _Category call({required int id, required String name, required int iconId}) {
    return _Category(
      id: id,
      name: name,
      iconId: iconId,
...
class _$_Category implements _Category {
  _$_Category({required this.id, required this.name, required this.iconId});
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, iconId: $iconId)';
  }
...
abstract class _Category implements Category {
  factory _Category(
      ...
      required int iconId}) = _$_Category;
